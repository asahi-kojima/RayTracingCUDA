...
public:
	...
	__device__ static Vec3 generateRandomDirectionOnUnitSphere(const Vec3& normal);
	__device__ static Vec3 generateRandomDirectionOnUnitHemiSphere(const Vec3& normal);
};
